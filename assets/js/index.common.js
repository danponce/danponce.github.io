          ...
          var object = results[i];
            ...
            if(diffDays > 0)
            {
                if(diffDays == 1)
                    ...
                    diferencia = "Hace " + diffDays + " Días Atrás";
            }
            else
            {
                if(diffHrs > 0)
                {
                    if(diffHrs == 1)
                        diferencia = "Hace 1 Hora";
                    else
                        diferencia = "Hace " + diffHrs + " Horas Atrás";
                }
                else
                {
                    if(diffMins < 2)
                        diferencia = "Hace Unos Momentos";
                    else
                        diferencia = "Hace " + diffMins + " Minutos";
                }
            }
